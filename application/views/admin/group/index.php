		...
		<div class="page-title">
			...
			<div class="title_right">
				<ol class="breadcrumb pull-right">
					<li class="breadcrumb-item"><a href="<?= my_library::admin_site()?>">Dashboard</a></li>
											...
											<td style="width: 300px;"><?= $value['group_name']?>
												<div style="height: 20px;">
						                            <div class="actionhover">
						                              <a href="<?= $linkEdit?>" class="text-primary"><?= lang('edit')?></a> | <a href="<?= $linkPermission?>" class="text-success"><?= lang('groupper')?></a> | <a href="javascript:void(0)" onclick="confirm_delete(<?= $value['id']?>)" class="text-danger"><?= lang('delete')?></a>
						                            </div>
						                        </div>
											</td>
