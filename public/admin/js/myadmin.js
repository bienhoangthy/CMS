...
function alertChange($language='vietnamese'){
  var title = "Bạn muốn thay đổi?";
  var text = "Thay đổi trường này sẽ chuyển tất cả nội dung bạn đang chỉnh sửa về ngôn ngữ bạn đang chọn!";
  if (configs.lang == 'english') {title = "Are you sure?";text = "Changing this field will move all the content you are editing to the language you are currently selecting!";}
  swal({
    title: title,
    text: text,
    type: "warning",
